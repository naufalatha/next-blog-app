...
export default function Navbar() {
    ...
    const dropdownList = [
        { text: 'Soft Skill', href: '/posts' },
        { text: 'Roadmap', href: '/posts' },
    ]
        ...
        <nav className="py-10">
            <Container>
                <div className="flex items-center">
                    ...
                    <div
                        className={`lg:w-7/12 w-full bg-gradient-to-b from-gray-600 to-gray-900 lg:bg-none fixed lg:static top-0 h-full lg:h-auto p-12 lg:p-0 transition-all ${
                            offcanvas ? 'left-0' : '-left-full'
                        }`}
                    >
                        <button
                            className="absolute top-12 right-12 lg:hidden"
                        ...
                        <ul className="lg:space-x-12 flex lg:items-center flex-col lg:flex-row space-y-4 lg:space-y-0">
                            <li>
                                <Link href="/posts">
                    ...
                    >
                        ...
                        <input
                            className="bg-gray-700 py-3 px-6 w-full lg:rounded-full rounded-lg"
                            placeholder="Search..."
                        ></input>
                    </div>
                </div>
